...
public class LevelFive extends BaseScreen {
    ...
    public void create()
    {
        ...
        Color[] colorArray = {Color.NAVY, Color.LIME, Color.CYAN, Color.PINK, Color.YELLOW, Color.PURPLE, Color.ORANGE, Color.RED, Color.BLUE};
