...
public class LevelTwo extends BaseScreen
{
    ...
    public void create()
    {
        ...
        Color[] colorArray = {Color.NAVY, Color.BLUE, Color.ROYAL, Color.CYAN,  Color.SKY, Color.GRAY, Color.DARK_GRAY};
    ...
    public void update(float dt)
    {
        ...
        if(brickList.isEmpty())
        {
...

            {
                ball.multVelocityX(0);
                ball.multVelocityY(0);
                TextButton startButton = new TextButton("You win!!! Level 3", game.skin, "uiTextButtonStyle");
                startButton.addListener(
                        new InputListener()
                        {
                            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button)
