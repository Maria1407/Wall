...
public class LevelThree extends BaseScreen
{
    ...
    public void create()
    {
        ...
        Color[] colorArray = {Color.WHITE, Color.LIGHT_GRAY, Color.SLATE, Color.GRAY, Color.DARK_GRAY, Color.TEAL, Color.OLIVE, Color.FOREST};
    ...
    public void update(float dt)
    {
        ...
        if(brickList.isEmpty())
        {
...

            {
                ball.multVelocityX(0);
                ball.multVelocityY(0);
                TextButton startButton = new TextButton("You win!!! Level 4", game.skin, "uiTextButtonStyle");
                startButton.addListener(
                        new InputListener()
                        {
                            public boolean touchDown (InputEvent event, float x, float y, int pointer, int button)
